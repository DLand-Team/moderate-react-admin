...
exports.formUploadPut = exports.getQiniuTokenWithName = exports.getQiniuToken = void 0;
...
exports.getQiniuTokenWithName = getQiniuTokenWithName;
// 服务器端上传到七牛
function formUploadPut(fileName, file) {
    ...
    return new Promise((resolve, reject) => {
        formUploader.putFile(uploadToken, fileName, file, putExtra, (respErr, respBody, respInfo) => {
            if (respErr) {
                reject(respErr);
            }
...
exports.formUploadPut = formUploadPut;
