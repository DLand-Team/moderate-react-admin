                            ...
                            >
                                <Select
                                    ...
                                    options={[
                                        {
                                            value: "1",
                                            label: t`sortItem.TravelTime`,
                                        },
                                        {
                                            value: "2",
                                            label: t`sortItem.Connection`,
                                        },
                                        {
                                            value: "3",
                                            label: t`sortItem.Price`,
                                        },
                                        {
                                            value: "4",
                                            label: t`sortItem.DepartureTime`,
                                        },
                                        {
                                            value: "5",
                                            label: t`sortItem.ArrivalTime`,
                                        },
                                        {
                                            value: "6",
                                            label: t`sortItem.Online`,
                                        },
                                        {
                                            value: "7",
                                            label: t`sortItem.Nocodeshare`,
                                        },
                                        {
                                            value: "8",
                                            label: t`sortItem.Sortscore`,
                                        },
                                    ]}
                                />
                            </Form.Item>
