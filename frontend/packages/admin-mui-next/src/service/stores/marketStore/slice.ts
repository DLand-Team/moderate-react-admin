...
import { createSlice } from "@/service";
import {
    GetMarketListApiRes,
    Market,
    MarketCarrier,
...
const slice = createSlice({
    name: "marketStore",
    branch: [
        ROUTE_ID.MarketDetailPage,
        ROUTE_ID.MarketAddPage,
        ROUTE_ID.MarketEditPage,
    ],
    ...
    reducers: {
        ...
        setMarketItemtablePageNum(state, { payload }: PayloadAction<number>) {
            state.marketItemtablePageNum = payload;
        },
    },
});
