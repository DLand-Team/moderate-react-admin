    ...
    askData = [
      ...
      },
      {
        ...
        fieldConfig: {
          ...
          formOptions: {
            initialValue: recordData?.ask?.sell_a_business.vendor_finance,
            rules: [
              {
                required: true,
              },
          ...
          <a
            onClick={() => {
              Modal.confirm({
                ...
                width: 800,
                content: (
                  <Descriptions title="deal detail" column={2}>
      ...
      },
      {
        ...
        render: (_, record) => (
          <Space size="middle">
            ...
            {record.is_draft && record.is_submitted && !record.is_approved && (
              <a
                onClick={async () => {
                  await approveAct({
                    id: record.id,
            ...
            {record.is_draft && record.is_submitted && !record.is_approved && (
              <a
                onClick={async () => {
                  ...
                  Modal.confirm({
                    title: "reject reason",
                    content: <RejectReasonModal resolver={resolver} />,
                    icon: null,
                    async onOk() {
                      ...
                      const x = {
                        id: record.id,
                        reject_reason:
                          resolver.form.getFieldValue("reject_reason"),
                      };
